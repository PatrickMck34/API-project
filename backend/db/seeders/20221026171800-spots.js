...
module.exports = {
  ...
  async up (queryInterface, Sequelize) {
   ...
   await queryInterface.bulkInsert(options, [
    ...
    lng: 23.5,
    name: 'Brick cottage',
    description: 'A quaint brick cottage tucked away off the beaten path.',
    price: 135.00,
    avgRating: 3.0,
    avgStarRating: 4.1,
    numReviews: 1,
...
avgStarRating: 4.1,
  ...
  address: '123 new life street',
    ...
    lng: 23.5,
    name: 'Stone retreat',
    description: 'A beautiful natural stone home complete with all the ammenities of a private castle.',
    price: 135.00,
    avgRating: 2.2,
    avgStarRating: 4.1,
    numReviews: 1,
