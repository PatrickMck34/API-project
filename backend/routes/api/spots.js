...
const {id, ownersId, address, city, state, country, lat, lng, name, description, price} = req.body;
  const spot = await Spot.CreateNewSpot({id, ownersId, address, city, state, country, lat, lng, name, description, price})
